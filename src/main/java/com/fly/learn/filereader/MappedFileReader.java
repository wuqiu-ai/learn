...
public class MappedFileReader {
    ...
    public static void main(String[] args) throws IOException {
        MappedFileReader reader = new MappedFileReader("/Users/peijiepang/Downloads/ideaIU-2020.1.1.dmg", 65536);
        ...
        reader.close();
        System.out.println("MappedFileReader: " + (end - start) +" 读取次数:"+count);
    }
